...
class Networks {
  ...
  static Fantom = new Network("fantom", "https://fantom.publicnode.com", 18, 250n, 0, "FTM", "https://ftmscan.com/")

  static Celo = new Network("celo", "https://1rpc.io/celo", 18, 42220n, 0, "CELO", "https://celoscan.io/")

  static ZkSync = new Network("zksync", "https://mainnet.era.zksync.io", 18, 324n, 2, "ETH", "")

  static Gnosis = new Network("gnosis", "https://rpc.ankr.com/gnosis", 18, 100n, 2, "xDAI", "https://gnosisscan.io/")
